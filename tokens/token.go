...
//
// Solidity: function balanceOf(address wallet) view returns(uint256)
func (_Main *MainCaller) BalanceOf(opts *bind.CallOpts, wallet common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Main.contract.Call(opts, &out, "balanceOf", wallet)
...
//
// Solidity: function balanceOf(address wallet) view returns(uint256)
func (_Main *MainSession) BalanceOf(wallet common.Address) (*big.Int, error) {
	return _Main.Contract.BalanceOf(&_Main.CallOpts, wallet)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address wallet) view returns(uint256)
func (_Main *MainCallerSession) BalanceOf(wallet common.Address) (*big.Int, error) {
	return _Main.Contract.BalanceOf(&_Main.CallOpts, wallet)
}
